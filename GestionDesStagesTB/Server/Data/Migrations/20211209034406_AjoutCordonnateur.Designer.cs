...
namespace GestionDesStagesTB.Server.Data.Migrations
{
    ...
    [Migration("20211209034406_AjoutCordonnateur")]
    partial class AjoutCordonnateur
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GestionDesStagesTB.Server.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("GestionDesStagesTB.Shared.Models.Coordonateur", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("GestionDesStagesTB.Shared.Models.PieceJointe", b =>
                {
                    ...
                    b.Property<DateTime>("DateVersee")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("GestionDesStagesTB.Shared.Models.StageStatut", b =>
                {
                    b.Property<int>("StageStatutId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("DescriptionStatut")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.HasKey("StageStatutId");

                    b.ToTable("StageStatut");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("GestionDesStagesTB.Server.Models.ApplicationUser", null)
                        .WithMany()
